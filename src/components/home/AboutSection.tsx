            ...
            <div className="lg:pt-12">
              <div className="border-l-2 border-primary pl-8">
                <p className="font-serif text-lg md:text-xl text-foreground italic leading-relaxed">
                  "We don't believe in scaling for the sake of growth. 
                  We believe in growing alongside our artists — 
                  at a pace that serves their careers, not our ambitions."
                </p>
              </div>
              <div className="mt-12">
